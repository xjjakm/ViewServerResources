### this fork add zh_cn language and update Minecraft version to 26.1.2,For compatibility,The interface for downloading the resource pack might not work or could be overwritten
